...
public class MyServiceImplGenerator extends BaseModelGenerator {

    String basePackage;
    String modelPackage;

    public MyServiceImplGenerator(String basePackage, String modelPackage) {
        super(basePackage + ".impl", PathKit.getWebRootPath() + "/src/main/java/" + (basePackage + ".impl").replace(".", "/"));

        this.basePackage = basePackage;
        this.modelPackage = modelPackage;
        this.template = "/okkpp/generator/service/service_impl_template.jf";
